 ...
 *        RTOS                   :  Windows 7 pro
 *
 *        Create Data            :	2016/04/01
 *        Author/Corportation    :	Gaunthan
 *
 *        Abstract Description   :	offers API of Bitmap file's data structure.
 *
 *--------------------------------Revision History--------------------------------------
 *       No      version     Date       Revised By      Item        Description
 *       1       v1.0        2016/4/1	Gaunthan                    Create this file
 *
 ***************************************************************************************/
...
**************************************************************/
/* 对于24位真彩色 每一行的像素宽度必须是4的倍数  否则补0补齐 */
